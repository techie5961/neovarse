...
@section('main')
    <section class="w-full p-20 column g-10">
        <form method="POST" action="{{ url('admins/post/add/skill/process') }}" onsubmit="PostRequest(event,this,MyFunc.added)" style="border:1px solid var(--rgb-02);background:white" class="w-full br-20 p-20 column g-10">
                {{-- header --}}
            ...
            <div class="row w-full c-primary align-center g-10">
               <span>
                ...
                <strong class="desc">Add Skill</strong>
            </div>
           ...
           {{--new input --}}
            ...
            <div class="column w-full g-5">
                ...
                <div class="w-full cont br-10 overflow-hidden h-50 row align-center" style="border:1px solid var(--rgb-01);background:var(--rgb-005)">
                    <input name="name" placeholder="E.g Data Science" type="text" class="w-full required inp input h-full br-10 g-10 border-none bg-transparent">
                </div>
            </div>
              {{--new input --}}
            <div class="column w-full g-5">
                ...
                <div class="w-full cont br-10 overflow-hidden h-50 row align-center" style="border:1px solid var(--rgb-01);background:var(--rgb-005)">
                    <input name="category" placeholder="E.g analytics" type="text" class="w-full required inp input h-full br-10 g-10 border-none bg-transparent">
                </div>
            </div>
               {{--new input --}}
            <div class="column w-full g-5">
                ...
                <div class="w-full cont br-10 overflow-hidden h-50 row align-center" style="border:1px solid var(--rgb-01);background:var(--rgb-005)">
                    <input name="community" placeholder="E.g https://wa.me/the-group-link" type="url" class="w-full required inp input h-full br-10 g-10 border-none bg-transparent">
                </div>
            </div>
              {{--new input --}}
            <div class="column w-full g-5">
                ...
                <div class="w-full cont br-10 overflow-hidden h-150 row align-center" style="border:1px solid var(--rgb-01);background:var(--rgb-005)">
                    <textarea name="description" placeholder="E.g Python, SQL, analytics. Turn data into decisions." type="text" class="w-full required inp input h-full br-10 g-10 border-none bg-transparent"></textarea>

                </div>
            </div>
            <button class="post">Add Skill Now</button>
